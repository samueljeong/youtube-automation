...
- 문체는 '강연형 설교' 스타일로, 자연스럽고 대화하듯이, 그러나 가볍지 않게 작성합니다.`,
      ...
      writing_style: {
        label: "문단/줄바꿈 스타일 (중요)",
        description: "설교문의 가독성과 A4 분량 최적화를 위한 작성 규칙",
        rules: [
          "설교문은 '강연형 문단'으로 작성하고, 한 문단 안에 2~4문장을 묶어서 작성합니다.",
          "한 문장마다 줄바꿈하지 말고, 의미가 바뀌는 지점에서만 문단을 나눕니다.",
          "한 줄짜리 짧은 문단을 연속으로 만들지 않습니다. (강조가 꼭 필요할 때만 예외적으로 사용)",
          "[아이스브레이킹], [서론], [1대지], [2대지], [3대지], [결론] 사이에서만 빈 줄(공백 줄)을 넣고, 그 외에는 문단 사이에 공백 줄을 남발하지 않습니다.",
          "전체 분량은 지정된 설교 시간에 맞추되, 워드/A4 기준으로 약 8~11쪽 안에 들어갈 수 있도록 불필요한 반복과 장황한 표현은 줄이고, 핵심 문장을 중심으로 압축해서 작성합니다."
        ],
        note: "이 규칙을 지키면 같은 분량이어도 페이지 수가 크게 줄어듭니다."
      },

      scripture_citation: {
        label: "성경구절 인용 방식 (아주 중요)",
        description: "본문 구절과 보충 성경구절의 가독성 확보를 위한 규칙",
        rules: [
          "본문 구절이든 보충 성경구절이든, 설교문 안에서는 항상 '설명 한두 문장 + 다음 줄에 구절 한 줄' 형식으로 작성합니다.",
          "형식 예시: '이런 상황에 대해 성경은 이렇게 말합니다.' (줄바꿈) '창세기 30:25 \"라헬이 요셉을 낳았을 때에 야곱이 라반에게 이르되…\"'",
          "같은 장 안에서 절만 강조할 때도 같은 형식을 사용합니다. 예: '25절은 이렇게 말합니다.' (줄바꿈) '25절 \"라헬이 요셉을 낳았을 때에…\"'",
          "괄호 안에 (창30:25), (잠16:9)처럼 짧게 넣는 인라인 표기 방식은 사용하지 않습니다. 항상 한 줄을 온전히 사용해서 성경구절을 보여 주세요.",
          "보충 성경구절을 제시할 때도 같은 규칙을 적용합니다. 예: '이 원리를 잠언은 이렇게 말합니다.' (줄바꿈) '잠언 16:9 \"사람이 마음으로 자기의 길을 계획할지라도…\"'",
          "성경구절 위아래에는 불필요한 빈 줄을 여러 줄 넣지 말고, 바로 앞 문장 다음 줄에 구절을 쓰고, 다시 그 다음 줄부터 설교 내용을 이어갑니다."
        ],
        note: "이 규칙을 지키면 본문/보충 구절이 눈에 바로 보이고, 나중에 PPT나 핸드아웃으로 옮기기도 쉬워집니다."
      }
    }
  },
  "강해설교": {
    ...
    "step3": {
      ...
      "writing_style": {
        ...
        "rules": [
          ...
          "한 문장마다 줄바꿈하지 말고, 의미가 바뀌는 지점에서만 문단을 나눕니다.",
          "한 줄짜리 짧은 문단을 연속으로 만들지 않습니다. (강조가 꼭 필요할 때만 예외적으로 사용)",
          "[아이스브레이킹], [서론], [대지1], [대지2], [대지3], [결론] 사이에서만 빈 줄(공백 줄)을 넣고, 그 외에는 문단 사이에 공백 줄을 남발하지 않습니다.",
          "전체 분량은 지정된 설교 시간에 맞추되, 워드/A4 기준으로 약 8~11쪽 안에 들어갈 수 있도록 불필요한 반복과 장황한 표현은 줄이고, 핵심 문장을 중심으로 압축해서 작성합니다."
        ],
        "note": "이 규칙을 지키면 같은 분량이어도 페이지 수가 크게 줄어듭니다."
      },
