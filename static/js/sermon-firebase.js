  ...
  "3대지": {
    ...
    "step3": {
      ...
      "output_format": {
        ...
        "structure": {
          "제목": "Step2의 설교_제목 사용",
          "아이스브레이킹": "서론 전 청중과의 라포 형성 (일상 이야기, 가벼운 유머, 공감 질문 등)",
      ...
      "writing_guidelines": {
        "아이스브레이킹": {
          "목적": "청중의 주의를 집중시키고 설교자와의 라포 형성",
          "내용": ["최근 일상 이야기", "가벼운 유머나 에피소드", "청중에게 던지는 공감 질문", "시사적 이슈나 계절 이야기"],
          "분량": "2-4문장",
          "주의": "본문 내용과 자연스럽게 연결되도록 구성"
        },
