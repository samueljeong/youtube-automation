...
- 문체는 '강연형 설교' 스타일로, 자연스럽고 대화하듯이, 그러나 가볍지 않게 작성합니다.`,
      ...
      writing_style: {
        label: "문단/줄바꿈 스타일 (매우 중요 - 반드시 준수)",
        description: "설교문의 가독성과 A4 분량 최적화를 위한 작성 규칙. 이 규칙을 어기면 페이지 수가 2배 이상 늘어납니다.",
        rules: [
          "한 문단에 2~4개의 문장을 연속으로 이어서 씁니다. 문장 끝에서 줄바꿈(Enter)하지 마세요.",
          "문단과 문단 사이에만 빈 줄 1개를 넣습니다.",
          "대지 제목([1대지], [2대지] 등), 섹션 제목([서론], [결론] 등) 앞뒤에만 줄바꿈합니다.",
          "질문형 문장이나 강조 문장도 따로 줄을 만들지 말고, 같은 문단 안에 자연스럽게 포함시킵니다.",
          "성경구절 인용만 예외적으로 별도 줄에 작성합니다."
        ],
        bad_example: "여러분, 혹시 이런 생각해 본 적 있나요?\\n\"내가 이렇게 열심히 준비하는데…\"\\n\"왜 결과는 늘 애매할까?\"\\n우리는 모두 공정한 보상을 기대합니다.\\n수고한 만큼 거두고 싶어 합니다.",
        good_example: "여러분, 혹시 이런 생각해 본 적 있나요? \"내가 이렇게 열심히 준비하는데… 왜 결과는 늘 애매할까?\" 우리는 모두 공정한 보상을 기대합니다. 수고한 만큼 거두고 싶어 합니다.\\n\\n그런데 현실은 자주 그렇지 않습니다. 그래서 마음이 서운하고, 비교하게 되고, 때로는 하나님께 섭섭함도 생깁니다. 오늘 우리는 야곱의 이야기를 통해 하나님이 축복하시는 방식이 우리 계산과 꽤 다르다는 것을 함께 보려 합니다.",
        critical_note: "bad_example처럼 작성하면 17쪽, good_example처럼 작성하면 8~11쪽이 됩니다. 반드시 good_example 형식을 따르세요."
      },

      scripture_citation: {
        label: "성경구절 인용 방식 (매우 중요)",
        description: "본문 구절과 보충 성경구절의 가독성 확보 및 출처 명시 규칙",
        rules: [
          "성경구절을 인용할 때는 '설명 문장 + 줄바꿈 + 구절(출처 포함)' 형식으로 작성합니다.",
          "보충 성경구절에는 반드시 책 이름과 장:절을 명시합니다. 출처 없이 구절만 쓰지 마세요.",
          "괄호 안에 (롬8:28), (고후12:9)처럼 인라인으로 넣지 않습니다.",
          "보충 구절은 남용하지 말고, 대지당 1~2개 정도로 본문 메시지를 뒷받침하는 곳에만 사용합니다.",
          "보충 구절은 Step1의 cross_references에서 제시한 구절을 우선 사용합니다."
        ],
        format_example: {
          intro: "바울은 이 원리를 이렇게 고백합니다.",
          citation: "고린도후서 12:9 \"내 은혜가 네게 족하다. 이는 내 능력이 약한 데서 온전해짐이라.\""
        },
        bad_example: "하나님은 약한 자를 사용하십니다(고후12:9). 우리는 신뢰해야 합니다(롬8:28).",
        good_example: "바울은 이 원리를 이렇게 고백합니다.\\n고린도후서 12:9 \"내 은혜가 네게 족하다. 이는 내 능력이 약한 데서 온전해짐이라.\"\\n\\n이 약함의 자리에서 하나님의 능력이 온전해집니다.",
        usage_guide: "보충 구절은 설교를 풍성하게 해주지만, 본문 해석을 흐리지 않도록 꼭 필요한 곳에만 사용하세요. 한 설교에 3~5개 정도가 적당합니다."
      }
    }
  },
  "강해설교": {
    ...
    "step3": {
      ...
      "writing_style": {
        ...
        "rules": [
          "한 문단에 2~4개의 문장을 연속으로 이어서 씁니다. 문장 끝에서 줄바꿈(Enter)하지 마세요.",
          "문단과 문단 사이에만 빈 줄 1개를 넣습니다.",
          "대지 제목([대지1], [대지2] 등), 섹션 제목([서론], [결론] 등) 앞뒤에만 줄바꿈합니다.",
          "질문형 문장이나 강조 문장도 따로 줄을 만들지 말고, 같은 문단 안에 자연스럽게 포함시킵니다.",
          "성경구절 인용만 예외적으로 별도 줄에 작성합니다."
        ],
        "bad_example": "여러분, 혹시 이런 생각해 본 적 있나요?\\n\"내가 이렇게 열심히 준비하는데…\"\\n\"왜 결과는 늘 애매할까?\"\\n우리는 모두 공정한 보상을 기대합니다.\\n수고한 만큼 거두고 싶어 합니다.",
