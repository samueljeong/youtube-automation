...
## 출력 규칙
1. 추천은 정확히 3개
2. 각 추천에 본문, 제목, 방향, 서론, 3대지 상세, 결론 포함
  ...
  "recommendations": [
    {
      ...
      "title": "삶의 골짜기를 지나는 청년에게",
      "direction": "하나님의 인도하심 / 두려움 극복 / 미래 신뢰",
      "intro": "서론 요약 (1-2문장): 청중의 관심을 끌고 본문으로 이끄는 도입",
      "points": [
        {
          "title": "하나님의 인도하심",
          "verse": "1-3절",
          "content": "목자의 돌봄 - 푸른 초장, 쉬는 물가로 인도하심"
        },
        {
          "title": "두려움 극복",
          "verse": "4절",
          "content": "사망의 음침한 골짜기에서도 두려워하지 않음"
        },
        {
          "title": "미래 신뢰",
          "verse": "5-6절",
          "content": "원수 앞에서 상을 차려주심, 영원한 동행"
        }
      ],
      "conclusion": "결론 요약 (1-2문장): 핵심 메시지와 적용 촉구",
