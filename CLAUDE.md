...
**금지 패턴:**
- "~할까요?" (명확한 요청에 되묻기)
- "~하면 될까요?" (이미 지시받은 것 재확인)
- "~맞나요?" (명백한 것 확인)

**예시:**
- ❌ "설교 확인해봐" → "확인했습니다. 작성할까요?"
- ✅ "설교 확인해봐" → 확인 후 바로 작성까지 완료

---

## 🔄 Git 자동화 (필수)

> **배경**: 회사/집 두 환경에서 작업하므로 항상 동기화 필수
...
| 시점 | 명령어 | 목적 |
|------|--------|------|
| 커밋 전 | `git pull --rebase` | 다른 환경 변경사항 가져오기 |
| 커밋 후 | `git push` | 즉시 원격에 반영 |
