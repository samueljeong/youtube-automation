...
★ 문장 스타일
════════════════════════════════════════
• 기본 호흡: 20~40자가 기본. 너무 짧으면 뚝뚝 끊김.
• 긴 문장도 필요: 50자 이상 문장을 문단마다 1~2개 섞기
• 리듬 변주: 중간(30자) 2개 → 짧은(20자) 1개 → 긴(50자) 1개
• 종결: ~합니다, ~입니다 (서술형)

❌ 10~15자 짧은 문장만 연속 금지 (뚝뚝 끊김)
❌ "왕은 멈추지 않습니다. 다음 성을 가리킵니다. 서기 391년." (너무 짧음)

✅ 좋은 예시:
  "광개토왕은 즉위하자마자 군대를 일으켜 남쪽으로 향합니다. 목표는 백제입니다. 한강을 움켜쥔 그 나라의 손을 풀어야 고구려의 숨통이 트입니다."

❌ 나쁜 예시:
  "왕이 칼을 뽑습니다. 결정의 순간입니다. 군대가 움직입니다. 성이 보입니다."
...
- "평양성 새벽." / "한강 유역의 진영." (장소 이동)
- "3년 뒤." / "그해 겨울." (시간 경과)
- "말이 달립니다." / "성문이 열립니다." (동작 시작)
- "'끝까지 간다.' 왕의 한마디였습니다." (대사 인용)
- "전선이 무너집니다." / "소식이 도착합니다." (상황 변화)
- "북소리가 울립니다." / "연기가 피어오릅니다." (감각 묘사)
