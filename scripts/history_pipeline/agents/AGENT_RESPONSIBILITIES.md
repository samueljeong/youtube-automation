...
┌─────────────────────────────────────────────────────────────────┐
│  ScriptAgent (대본)                                             │
│  - 12,000자 ±10% (10,800~13,200자) 대본 작성                    │
│  - **씬(Scene) 단위로 구분**: 인트로/배경/본론1/본론2/마무리     │
│  - 40-60대 대상 톤, TTS 최적화                                  │
│  ⚠️ 글자수 미달 시 진행 차단                                    │
└─────────────────────────────────────────────────────────────────┘
                              │
                              ▼
┌─────────────────────────────────────────────────────────────────┐
│  FactCheckAgent (사실 검증) - 신규                              │
│  - 역사적 사실 검증 (연도, 인물, 사건)                          │
│  - AI 허구(hallucination) 탐지                                  │
│  ⚠️ FALSE 등급 발견 시 진행 차단                                │
└─────────────────────────────────────────────────────────────────┘
                              │
                              ▼
┌─────────────────────────────────────────────────────────────────┐
│  ToneReviewAgent (어투/톤 검증) - 신규                          │
│  - 40-60대 대상 어투 지침 준수 여부 검증                        │
│  - TTS 적합성 검사 (문장 길이, 쉼표 사용)                       │
│  - 학술적 유보 표현 과다 사용 체크                              │
│  ⚠️ D등급 시 진행 차단                                         │
└─────────────────────────────────────────────────────────────────┘
                              │
