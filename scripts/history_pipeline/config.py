...
SCRIPT_BRIEF_TEMPLATE = """[대본 지시문 - {era_name}]

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
📌 기본 정보
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
- 시대: {era_name} ({period})
- 분량: 15~20분 (6,000~7,500자) ← 반드시 준수
- TTS 기준: 한국어 약 350자/분
...
[#BODY1_FACTS_ONLY] 본론 전반부 (약 2,500자) ★ 사실만
- 핵심 사실 3~5개를 시간순/인과순으로 나열
- 인물, 사건, 장소, 숫자 중심
- ❌ 감정/느낌/추측/행동 표현 절대 금지
- ❌ "~했을 것이다", "~느꼈다", "~가 되었다" 금지
...
[#BODY2_HUMAN_ALLOWED] 본론 후반부 (약 2,000자) ★ 감정 허용
- 여기서부터 인물의 심리, 행동, 느낌 묘사 가능
- 스토리텔링 강화
- 단, 과장/미화/민족주의 금지

[#IMPACT] 역사적 의의 (약 500자)
- 이 시대가 이후 역사에 미친 영향
- 현대와의 연결점 (선택)
...
- ❌ 교훈/훈계/친절한 마무리 금지
- 예: "그렇다면 이후 ___는 어떻게 되었을까?"

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
🚫 절대 금지 규칙
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

1. [60% 규칙] 행동/감정/느낌/추측 표현은 전체 분량의 60% 이후에서만 허용
   - 전반부(#OPEN, #BODY1_FACTS_ONLY)는 건조한 사실/구조만
   - 위반 시: 대본 전체 재작성

2. [중간요약 차단] 아래 표현 사용 금지:
   - "정리하면", "핵심은", "결론적으로", "요약하자면"
   - "다시 말해", "즉", "결국"
   - 본론 중간에 요약하지 말 것

3. [엔딩 밀도 제어] 결론부에서 금지:
   - 갑자기 친절해지는 문장
   - 교훈형/훈계형 마무리 ("~해야 합니다", "~를 기억합시다")
   - 시청자에게 직접 말 거는 투 ("여러분", "우리 모두")

4. [기타 금지]
   - 연도/사건 나열식 설명
   - 교과서 문체
   - 지나친 민족주의/국뽕 표현
   - "위대한", "찬란한", "자랑스러운" 등 미화 형용사

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
✅ 권장 사항
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

- 인물 중심 스토리텔링 (이름, 직책, 행동)
- "만약 ~했다면?" 가정법 활용 (전환점에서)
- 구체적 숫자/장소/날짜 사용
- 짧은 문장 선호 (1문장 40자 이내)
- 현대 시청자가 공감할 수 있는 보편적 상황 비유 (후반부에서만)
"""
