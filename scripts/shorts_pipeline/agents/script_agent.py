...
- 씬1 (3초, 30자, 4-5문장): 훅 - "{context.person}. 갑질. 터졌다. 이번엔 진짜다. 큰일났다."
- 씬2 (8초, 80자, 5-6문장): 팩트 - "매니저에게 폭언. 부당대우. 제보 폭주. 녹음도 있대. 증거가 쌓인다."
- 씬3 (10초, 100자, 5-6문장): 핵심 - "불법 시술까지. 주사 놔줬대. 면허도 없이. 이건 범죄다. 선 넘었다."
- 씬4 (12초, 120자, 5-6문장): 🔥 댓글유도 - "{context.person} 잘못이다. vs 상대방 예민하다. 어느 쪽이야? 댓글로. 비슷한 경험 있어? 말해봐."
- 씬5 (7초, 70자, 4-5문장): 마무리 - "복귀? 쉽지 않다. 이미지 타격 크다. 3개월 뒤 어떨까? 지켜보자."
...
{{
    ...
    "scenes": [
        ...
        {{"scene_number": 2, "narration": "매니저에게 폭언. 부당대우. 제보 폭주. 녹음도 있대. 증거가 쌓인다. 심각하다.", "image_prompt": "..."}},
        {{"scene_number": 3, "narration": "불법 시술 의혹까지. 주사 놔줬대. 면허도 없이. 이건 범죄다. 선 넘었다. 진짜야 이거.", "image_prompt": "..."}},
        {{"scene_number": 4, "narration": "{context.person} 잘못이다. vs 매니저 예민하다. 어느 쪽이야? 댓글로. 비슷한 상사 있었어? 말해봐.", "image_prompt": "..."}},
        {{"scene_number": 5, "narration": "복귀? 쉽지 않다. 이미지 타격 크다. 3개월 뒤 어떨까? 지켜보자.", "image_prompt": "..."}}
    ],
