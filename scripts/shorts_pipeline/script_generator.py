...
✅ "박나래 갑질 의혹이 터졌습니다. 매니저한테 폭언했다는 거예요. 이번엔 진짜래요." (자연스러움)
...
### 씬3 (핵심, 10초, 80자) - 🔥 클라이맥스
- 가장 충격적인 내용 + **"진짜는 지금부터"** (2-3문장)
- "진짜 문제는 이거예요. 불법 시술 의혹까지 나왔어요. 면허도 없이 주사 놨다는 거예요. 이건 선 넘었죠."

### 씬4 (댓글 유도, 12초, 100자) - 💬 참여 유도
- **편가르기 + 경험 질문** (3-4문장)
- "이건 {celebrity} 잘못이다, 아니면 상대방이 예민한 거다. 솔직히 어느 쪽이에요? 비슷한 경험 있으면 댓글로 말해주세요."
...
{{
    ...
    "scenes": [
        ...
        {{
            "scene_number": 4,
            "duration": "21-33초",
            "narration": "이건 {celebrity} 잘못이다, 아니면 상대방이 예민한 거다. 솔직히 어느 쪽이에요? 비슷한 경험 있으면 댓글로 말해주세요.",
            "image_prompt": "이미지 프롬프트",
            "text_overlay": "어느 쪽?",
            "emphasis": true
        }},
