...
### 예시
❌ "코미디언 박나래가 매니저에게 갑질 의혹을 받았다는 보도가 나왔습니다." (39자)
✅ "박나래. 갑질. 터졌다." (12자)

❌ "온라인에서는 비판과 우려의 목소리가 동시에 나오고 있습니다." (31자)
✅ "인터넷 난리남. 완전 갈림." (13자)
...
### 씬4 (댓글 유도, 12초) - 🔥 가장 중요!
- **반드시 편가르기 또는 질문 삽입**
- "{celebrity} 잘못 vs 상대방 예민. 솔직히 어느 쪽이야?"
- "이런 경험 있는 사람? 댓글로 알려줘."
...
{{
    ...
    "scenes": [
        ...
        {{
            "scene_number": 4,
            "duration": "21-33초",
            "narration": "{celebrity} 잘못 vs 매니저 예민. 솔직히 어느 쪽이야? 댓글로.",
            "image_prompt": "이미지 프롬프트",
            "text_overlay": "어느 쪽?",
            "emphasis": true
        }},
