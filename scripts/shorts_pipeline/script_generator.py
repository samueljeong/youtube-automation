...
### 씬2 (상황, 8초, 80자) - 🔒 이탈 방지!
- 팩트 + **"근데 여기서 끝이 아니야"** (5-6문장)
- "매니저에게 폭언. 부당대우. 제보 폭주. 근데 이게 다가 아니야. 더 있어."

### 씬3 (핵심, 10초, 100자) - 🔥 클라이맥스
- 가장 충격적인 내용 + **"진짜는 지금부터"** (5-6문장)
- "진짜는 이거야. 불법 시술 의혹. 주사 놔줬대. 면허도 없이. 이건 범죄다. 선 넘었다."

### 씬4 (댓글 유도, 12초, 120자) - 💬 참여 유도
- **편가르기 + 경험 질문** (5-6문장)
- "{celebrity} 잘못이다. vs 매니저가 예민하다. 솔직히 어느 쪽이야? 댓글로. 비슷한 상사 있었어? 말해봐."

### 씬5 (마무리, 7초, 70자) - 🔄 여운 + 반복시청 유도
- 예측 + 미해결 궁금증 (4-5문장)
- "복귀? 쉽지 않다. 근데 반전 있을 수도. 3개월 뒤 어떨까? 지켜보자."
- ❌ 씬1 반복 금지

## 📝 체크리스트
1. ☐ **총 글자수 300-400자?**
2. ☐ **씬2에 "이게 다가 아니야" 류 이탈 방지 문구?** (리텐션!)
3. ☐ **씬3에 "진짜는 이거야" 류 클라이맥스?** (리텐션!)
4. ☐ 씬4에 편가르기/질문 있음?
5. ☐ 모든 문장 12자 이하?
6. ☐ "여러분" 사용 안 함?
...
{{
    ...
    "scenes": [
        ...
        {{
            "scene_number": 2,
            "duration": "3-11초",
            "narration": "매니저에게 폭언. 부당대우. 제보 폭주. 근데 이게 다가 아니야. 더 있어.",
            "image_prompt": "이미지 프롬프트",
            "text_overlay": "폭언",
            "emphasis": false
        }},
        {{
            "scene_number": 3,
            "duration": "11-21초",
            "narration": "진짜는 이거야. 불법 시술 의혹. 주사 놔줬대. 면허도 없이. 이건 범죄다. 선 넘었다.",
            "image_prompt": "이미지 프롬프트",
            "text_overlay": "불법시술",
            "emphasis": true
        }},
        ...
        {{
            "scene_number": 5,
            "duration": "33-40초",
            "narration": "복귀? 쉽지 않다. 근데 반전 있을 수도. 3개월 뒤 어떨까? 지켜보자.",
            "image_prompt": "이미지 프롬프트",
            "text_overlay": "복귀?",
            "emphasis": false
        }}
