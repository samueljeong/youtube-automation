...
⭕ 각 핵심포인트는 반드시:
   - "시청자가 이걸 왜 신경 써야 하는지" 또는
   - "그래서 생활에서 어떤 판단이 달라지는지" 설명
⭕ "~을 점검해야 한다", "~을 다시 생각해봐야 한다" 같은 판단 유도 문체 사용
⭕ 모든 포인트는 '생각을 여는 문장' 형태로

[좋은 예시 vs 나쁜 예시]
❌ 나쁨: "환율이 1,470원 안팎으로 예상된다"
⭕ 좋음: "환율 숫자보다 중요한 건, 이 수준이 '일상화'되고 있다는 점이다"

❌ 나쁨: "물가가 2% 초중반을 유지할 전망이다"
⭕ 좋음: "물가 뉴스는 자산 뉴스가 아니라 생활비 뉴스로 봐야 한다"
